            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <section class="bg-white">
                    ...
                    <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                        ...
                        @endif
                        <h2 class="mb-4 text-xl font-bold text-gray-900 ">Edit Conference Details</h2>
                            ...
                            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                                <div class="sm:col-span-2">
                                    ...
                                    <input type="text" name="title" id="title"
                                           ...
                                           placeholder="Type conference title" required="" value="{{ old('title', $conference->title) }}">
                                    @error('title')
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <input type="text" name="venue" id="venue"
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                                           placeholder="Type conference venue" required="" value="{{ old('venue', $conference->venue) }}">
                                    @error('venue')
                                        <span class="text-red-500">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="w-full">
                                    ...
                                    <input type="datetime-local" name="start_at" id="start_at"
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                                           required="" value="{{ old('start_at', $conference->start_at->format('Y-m-d\TH:i')) }}">
                                    @error('start_at')
                                        <span class="text-red-500">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="w-full">
                                    ...
                                    <input type="datetime-local" name="end_at" id="end_at"
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                                           required="" value="{{ old('end_at', $conference->end_at->format('Y-m-d\TH:i')) }}">
                                    @error('end_at')
                                        <span class="text-red-500">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="w-full">
                                    ...
                                    <input type="text" name="speaker_name" id="speaker_name"
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                                           placeholder="Type speaker name" required="" value="{{ old('speaker_name', $conference->speaker_name) }}">
                                    @error('speaker_name')
                                        <span class="text-red-500">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="w-full">
                                    ...
                                    <input type="email" name="speaker_email" id="speaker_email"
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                                           placeholder="Type speaker email" required="" value="{{ old('speaker_email', $conference->speaker_email) }}">
                                    @error('speaker_email')
                                        <span class="text-red-500">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="w-full">
                                    ...
                                    <input type="text" name="ticket_cost" id="ticket_cost"
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                                           placeholder="$2999" required="" value="{{ old('ticket_cost', $conference->ticket_cost) }}">
                                    @error('ticket_cost')
                                        <span class="text-red-500">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="sm:col-span-2">
                                    ...
                                    <textarea id="description" name="description" rows="8"
                                              ...
                                              placeholder="Your description here">{{ old('description', $conference->description) }}</textarea>
                                    @error('description')
                                        <span class="text-red-500">{{ $message }}</span>
                                    @enderror
                                </div>
